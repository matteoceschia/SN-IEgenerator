  ...
  for (size_t i = start; i < argc; i++) {
    ...
    if (currentArg[0] == '-' && currentArg.size() > 1) {
      ...
      if (currentArg[1] == '-') {
        ...
        //  'arguments' * integer negative numbers of more than 1 digit length
        //  are also 'arguments' * integer negatives of 1 digit length can be
        //  either arguments or short options. * anything else: short options.
        int anInt;
        float aFloat;
